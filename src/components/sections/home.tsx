  ...
  return (<>
    <section className="relative bg-[url('/assets/images/home.jpg')] h-[800px] bg-no-repeat bg-cover bg-center bg-overlay before:bg-[rgba(65,73,89,.65)] text-white">
      <div className="container relative">
        <div className="pt-20 lg:pt-[155px] text-center text-balance">
          <h2 className="text-2xl lg:text-[40px] lg:leading-[50px] font-bold">BEST PLACE TO FIND AND EXPLORE THAT ALL YOU NEED</h2>
        ...
        <div className="mt-16">
          <div className="flex flex-wrap justify-center lg:px-12">
            {/* Form */}
            <div className="flex flex-col lg:flex-row space-y-8 lg:space-y-0 mt-4 text-gray-900 p-5 lg:p-0 lg:h-[70px] w-full lg:w-10/12 rounded-sm">
              <div className="relative flex justify-between flex-col lg:flex-row lg:w-1/2 items-center bg-white py-5 lg:py-0 px-7">
                ...
                <div className="absolute lg:relative right-5 lg:right-0">
